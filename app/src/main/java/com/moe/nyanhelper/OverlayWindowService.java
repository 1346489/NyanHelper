...
public class OverlayWindowService extends Service {
    ...
    private void setupMenu() {
        ...
        // ---- 主题页 ----
        m.radioBg0.setChecked(bgIndex == 0);
        m.radioBg1.setChecked(bgIndex == 1);
        m.radioBg2.setChecked(bgIndex == 2);
        m.radioText0.setChecked(textIndex == 0);
        m.radioText1.setChecked(textIndex == 1);
        m.radioText2.setChecked(textIndex == 2);
