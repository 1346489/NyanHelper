#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""最终校验 v3：chdir + 绝对路径，只看文件系统真实情况"""
import os, re, sys

BASE = "/data/workspace/NyanHelper-2.0"
os.chdir(BASE)
OK, ERR = [], []
...
grep("AndroidManifest.xml", r'android:name="\.AppContext"', "Application=AppContext")
grep("activity_main.xml", r'@drawable/avatar_main', "③主界面头像=第5张图")
grep("float_ball.xml", r'@drawable/icon_ball', "②悬浮球=第2张图")
grep("float_ball.xml", r'centerCrop', "悬浮球完美覆盖(centerCrop)")
grep("float_ball.xml", r'scaleType', "悬浮球scaleType")
...
grep("panel_settings.xml", r'swSnow', "设置: 雪花(左上动态)")
grep("panel_settings.xml", r'swMeteor', "设置: 流星(右上动态)")
grep("NyanConfig.java", r'public static void setSnow', "雪花/流星互斥")
grep("NyanConfig.java", r'isSnow\(', "雪花状态")
grep("NyanConfig.java", r'isMeteor\(', "流星状态")
...
grep("EffectOverlay.java", r'startSnow', "雪花动画startSnow")
grep("EffectOverlay.java", r'startMeteor', "流星动画startMeteor")
...
grep("MainActivity.java", r'FeaturesActivity', "主界面→功能")
grep("MainActivity.java", r'SettingsActivity', "主界面→设置")
grep("MainActivity.java", r'ThemeActivity', "主界面→主题")
...
grep("gen_icons.py", r'ic_launcher', "图标生成脚本支持第1张图")
